...
export const CITY_DATA: CityConfig[] = [
  ...
  },
  {
    ...
    isFocus: true,
    neighborSlugs: ["holon", "bat-yam", "nes-ziona", "yavne"]
  },
  {
    slug: "ashdod",
    name: "אשדוד",
  ...
  },
  {
    ...
    isFocus: true,
    neighborSlugs: ["ramla", "lod", "gedera"]
  },
  ...
  },
  {
    ...
    customIntro: "צריכים קייטרינג בשרי חם בלוד? אנו מספקים מגשי אוכל מוכן ביתי חם בלוד והסביבה. כשרות מהודרת של בד\"ץ הרב מחפוד ושירות אדיב ומהיר ישירות אליכם."
  },
  {
    slug: "shoham",
    name: "שוהם",
  ...
  },
  {
    ...
    customIntro: "מחפשים אוכל בשרי חם מוכן בראש העין? 'טעם מהודר' מספקת מגשי אוכל בשרי חם לשבתות חתן, בריתות ואזכרות בראש העין בכשרות המהודרת של בד\"ץ הרב מחפוד."
  },
  {
    slug: "modiin",
    name: "מודיעין",
