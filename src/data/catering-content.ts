...
export const CITY_DATA: CityConfig[] = [
  ...
  },
  {
    ...
    synagogues: ["בית כנסת הגדול", "בית כנסת אהבת רעים", "בית כנסת בית יוסף", "בית כנסת אור יצחק"],
  ...
  },
  {
    ...
    synagogues: ["בית כנסת הגדול", "בית כנסת תפילה למשה", "בית כנסת ישמח משה", "בית כנסת בית אל"],
  ...
  },
  {
    ...
    customIntro: "קייטרינג מוכן עד הבית באזור רמת השרון. שירות מושלם לאירועים פרטיים, מבר מצווה ועד אזכרה. כשרות מהודרת של בד\"ץ הרב מחפוד ואיכות בשרים ללא פשרות.",
  ...
  },
  {
    ...
    customIntro: "קייטרינג בשרי מומלץ באשקלון לשבת חתן ובריתות. אנו מספקים מגשי אוכל מבושל וחם בכשרות מהודרת של בד\"ץ יורה דעה ללא פשרות, ובמחיר ללא תחרות.",
