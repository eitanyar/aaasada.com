            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div style={{
                ...
                <ul style={{ display: "flex", flexDirection: "column", gap: "10px", listStyle: "none", padding: 0 }}>
                  <li style={{ display: "flex", alignItems: "flex-start", gap: "8px" }}><CheckIcon size={16} style={{ color: "var(--primary-gold)", marginTop: "4px" }} /> <span><strong>מבחר בשרים ב-58 ש"ח — כולל בקר:</strong> צלי בקר, רוסטביף וקבב כלולים במחיר הבסיסי. מתחרים זולים מגישים בד"כ עוף בלבד.</span></li>
