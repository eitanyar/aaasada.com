            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div style={{
                ...
                <ul style={{ display: "flex", flexDirection: "column", gap: "10px", listStyle: "none", padding: 0 }}>
                  <li style={{ display: "flex", alignItems: "flex-start", gap: "8px" }}><CheckIcon size={16} style={{ color: "var(--primary-gold)", marginTop: "4px" }} /> <span><strong>תפריט מלא ב-₪58 למנה:</strong> מנות נדיבות ועשירות שכולם אוהבים.</span></li>
                  <li style={{ display: "flex", alignItems: "flex-start", gap: "8px" }}><CheckIcon size={16} style={{ color: "var(--primary-gold)", marginTop: "4px" }} /> <span><strong>בשרים משובחים:</strong> צלי בקר ברוטב, פרגיות, כרעי עוף, קבב ביתי ועוד.</span></li>
